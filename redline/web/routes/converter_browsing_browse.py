"""
File system browsing and preview routes for converter operations.
Handles file system browsing and file preview.
"""
...
converter_browsing_browse_bp = Blueprint('converter_browsing_browse', __name__)
logger = logging.getLogger(__name__)

@converter_browsing_browse_bp.route('/browse')
...
@converter_browsing_browse_bp.route('/preview/<filename>')
