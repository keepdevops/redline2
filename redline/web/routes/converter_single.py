...
def convert_file():
    ...
    try:
        ...
        # If batch conversion fails, fall back to single file conversion
        logger.warning(f"Batch conversion failed, falling back to single file conversion: {str(batch_error)}")
