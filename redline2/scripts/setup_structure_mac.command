#!/bin/bash
# setup_structure_mac.command - Auto-create modular directory structure for redline2 (macOS)
# Run from the redline2 directory: ./scripts/setup_structure_mac.command
...
chmod +x scripts/*.sh
chmod +x scripts/setup_structure_mac.command

echo "redline2 modular structure created successfully (macOS)." 